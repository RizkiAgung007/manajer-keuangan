<x-app-layout>
    ...
    <script>
        ...
        // Fungsi utama yang dipanggil oleh CDN
        function initCharts() {
        ...
        // Fungsi untuk merender Grafik Pengeluaran (Merah)
        ...
        // Fungsi untuk merender Grafik Pemasukan (Hijau)
        ...
        // Listener untuk Dark Mode Toggle
...
toggle() {
    ...
    // ▼▼ TAMBAHKAN BARIS INI ▼▼
    // Ini akan "berteriak" ke window, dan grafik Anda akan mendengarnya
